...
\begin {enumerate}
    ...
    \begin{align*}
        (I \land f_{v} \leq 0) \equiv (0 \leq i \leq |ciudades| \land res = \sum\limits_{k=0}^{-1}{ciudades[k].habitantes} \land |ciudades| - i \leq 0)
        \equiv i = |ciudades| \land res = \sum\limits_{k=0}^{-1}{ciudades[k].habitantes}
    \end{align*}
