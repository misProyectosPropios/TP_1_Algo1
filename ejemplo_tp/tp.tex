...
\begin {enumerate}
    ...
    \item \begin{proc}{grandesCiudades}{\In ciudades : \TLista{Ciudad}} {\TLista{Ciudad}}
        \requiere{\True} 
	    \asegura{ \\
        \paraTodo[unalinea]{i}{Ciudad}{(i \in ciudades \land i_{1} \ge 50.000) \Rightarrow  (i \in res) \land \\
        \paraTodo[unalinea]{}{}{}}
    ...
    \item \begin{proc}{sumaDeHabitantes}{\In menoresDeCiudades : \TLista{Ciudad}, \In mayoresDeCiudades : \TLista{Ciudad}}{\TLista{Ciudad}}
        \requiere{
            \\
            sinRepetidos(menoresDeCiudades) \land sinRepetidos(mayoresDeCiudades) \land \\
            |menores| = |mayores| \land \\
            (todosElementosPositivos(menoresDeCiudades)) \land (todosElementosPositivos(menoresDeCiudades)) \\
        }
   ...
   \item \begin{proc}{hayCamino}{\In distancias : \TLista{\TLista{\ent}}, \In desde: \ent, \In hasta: \ent}{\bool}
        \requiere{\\
            ...
            (esMatrizSimetrica(distancias)) \land \\
            (todosElementosPositivos(distancias)) \\
        }
	    \asegura{\\
   ...
   \end{proc}
    ...
    \item \begin{proc}{cantidadCaminosNSaltos}{\Inout conexion : \TLista{\TLista{\ent}}, \In n : \ent}{}
        \requiere{ \\
            n > 0 \land \\ % O tiene que ser igual tambien?
            (esMatrizCuadrada(conexion)) \land \\
            (esMatrizSimetrica(conexion)) \land \\
            (todosElementos\_1\_o\_0(conexion)) \\ %Pensar mas casos
        }
	    \asegura{ \\
    ...
    %Ejercicio 1.5)
    %TODO
    % Preguntar si A -> A es camino valido o no
