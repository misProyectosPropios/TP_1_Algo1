...
%     $ 0 \leq i \leq |ciudades| \yLuego res = \sum\limits_{k=0}^{i - 1}{ciudades[i].habitantes}$
    ...
    \begin{itemize}
        ...
        \begin{align*}
            ...
            0 \leq &i \leq |ciudades| \yLuego res = \sum\limits_{k=0}^{i - 1}{ciudades[i].habitantes} \land |ciudades| \leq i \to i \geq |ciudades| \\
            &i = |ciudades| \yLuego res = \sum\limits_{k=0}^{i - 1}{ciudades[i].habitantes} \to i \geq |ciudades|  \\
            &i = |ciudades| \to i \geq |ciudades|
        \end{align*}
            Que es verdadero /TODO Poner una mejor idea


        Y como ambos son verdaderos, entonces termina el ciclo, terminando la demostracion de que el ciclo es correcto con respecto a su especificación
        \end{itemize}
