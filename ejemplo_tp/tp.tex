...
\subsection{Especificaci\'on}
    ...
    \begin{enumerate}
        ...
        \begin{proc}{caminoM\'inimo}{\In origen : \ent, \In destino : \ent, \In distancias: \TLista{\TLista{\ent}}}{\TLista{\ent}}\end{proc}
    \end{enumerate}
...
\begin {enumerate}
    %TODO
    \item Para hacer este ejercicio, necesimos proponer un invariante, junto con saber cual es la Post-condicion
    y la pre-condondicion. La post-condicion sabemos que es $res = \sum\limits_{i=0}^{|ciudades| - 1}{ciudades[i].habitantes}$ 
    porque no hay mas instrucciones despues del ciclo.
	\item
