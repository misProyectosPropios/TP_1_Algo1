...
\begin {enumerate}
    ...
    \item \begin{proc}{sumaDeHabitantes}{\In menoresDeCiudades : \TLista{Ciudad}, \In mayoresDeCiudades : \TLista{Ciudad}}{\TLista{Ciudad}}
        \requiere{\\
            sinRepetidos(menoresDeCiudades) \land sinRepetidos(mayoresDeCiudades) \\
            |menores| = |mayores| 
        }
    ...
    \item \begin{proc}{hayCamino}{\In distancias : \TLista{\TLista{\ent}}, \In desde: \ent, \In hasta: \ent}{\bool}
        \requiere{\\
            0 \leq desde < |distancias| \\ %Preguntar a ayudantes
            0 \leq hasta < |distancias| \\ %Preguntar a ayudantes
        }
	    \asegura{ \\
          res = \true  % \existe[unalinea]{variable}{tipo}{algo \yLuego expresion}
