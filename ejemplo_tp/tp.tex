...
\begin {enumerate}
    ...
    \item \begin{proc}{grandesCiudades}{\In ciudades : \TLista{Ciudad}} {\TLista{Ciudad}}
	    ...
	    \asegura{ \\
			\paraTodo[unalinea]{i}{Ciudad}{((i \in ciudades) \land (i.habitantes \geq 50.000)) \implica (i \in res) \land \\ 
			\paraTodo[unalinea]{j}{Ciudad}{(j \in res) \implica ((j.habitantes \geq 50.000) \land j \in ciudades)} 
			}
        }
	    ...
	    \pred{sonTodosPositivos}{ciudades: \TLista{Ciudad}}{
			\paraTodo[unalinea]{i}{Ciudad}{i \in ciudades \implica i.habitantes \geq 0}
		}

		\pred{sinRepetidos}{ciudades: \TLista{Ciudad}}{ 
			\paraTodo[unalinea]{i}{Ciudad}{i \in ciudades \implica \neg(
				\existe[unalinea]{j}{Ciudad}{j \neq i \land j \in ciudades \land j.nombre = i.nombre}
			)}
		}
    \end{proc}
